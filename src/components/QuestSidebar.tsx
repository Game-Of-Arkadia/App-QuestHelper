              ...
              >
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      setIsAddingConvInQuest(quest.id);
                    }}
                ...
                {isAddingConvInQuest === quest.id && (
                  <div
                    className="flex gap-2 p-2 bg-muted/30 border-t border-border"
                  >
                    <Input
                      value={newConvTitle}
                      ...
                      onKeyDown={(e) => e.key === 'Enter' && handleAddConversation(quest.id)}
                      autoFocus
                    />
                    <Button
                      size="sm"
                      onClick={() => handleAddConversation(quest.id)}
                      className="h-7 text-xs"
                    >
                      Add
                    </Button>
                ...
                >
                  ...
                  >
                    {quest.conversations && quest.conversations.length > 0 ? (
                      ...
                      <div
                        className="p-3 text-xs text-muted-foreground italic text-center"
                      >
